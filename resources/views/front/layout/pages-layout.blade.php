...
<head>
    ...
    <meta
    name="description"
    content="Laravel 10 multi-vendor marketplace with AI-assisted product recommendations"
    >
    <meta
        name="keywords"
        content="Laravel, multi-vendor marketplace, ecommerce, Gemini AI, shopping assistant"
    >
    <meta name="author" content="Hiren Vaddoriya">
