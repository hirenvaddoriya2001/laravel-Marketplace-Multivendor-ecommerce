                            ...
                            <li class="right-side">
                                ...
                                >
                                    ...
                                    @if($headerCartQuantity > 0)
                                        <span
                                            class="position-absolute top-0 start-100 translate-middle rounded-pill bg-danger text-white"
                                            style="
                                                min-width: 20px;
                                                height: 20px;
                                                padding: 2px 6px;
                                    ...
                                    <ul class="navbar-nav ijabo-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('checkout.create') }}">Checkout</a>
                                                </li>
                                                <li>
